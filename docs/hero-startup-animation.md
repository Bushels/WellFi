...
lit hold (0-3 s)
  ...
  -> three relay breaths in the dark (5-9 s)
       ...
       -> surface ring
       top-of-casing bubble highlights pressure, temperature, pump vibration
...
- HTML overlays are hidden unless their root has `data-wellfi-export-overlay`; the top-of-casing telemetry bubble uses that marker so it appears in MP4/GIF exports.
