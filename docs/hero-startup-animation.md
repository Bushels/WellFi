...
- HTML overlays are hidden unless their root has `data-wellfi-export-overlay`; the surface telemetry bubble uses that marker so it appears in MP4/GIF exports.
